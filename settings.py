...
class settings:
    ...
    MyCompanies = ['ZM','UBER','SWI','RNG','CRWD', 'WORK', 'AAPL']
    PortfolioOptimisationPath = r'C:\Users\richard.goldman\OneDrive - Accenture\Richard cloud\Personal\Quant\PortfolioOptimisation-master\PortfolioOptimisation-master\code'
